...
import com.zalocoders.dvtweatherapp.data.models.Clouds
import com.zalocoders.dvtweatherapp.data.models.Coord
import com.zalocoders.dvtweatherapp.data.models.CurrentLocationWeatherResponse
import com.zalocoders.dvtweatherapp.data.models.Daily
import com.zalocoders.dvtweatherapp.data.models.FeelsLike
import com.zalocoders.dvtweatherapp.data.models.ForeCastResponse
import com.zalocoders.dvtweatherapp.data.models.Main
import com.zalocoders.dvtweatherapp.data.models.Temp
import com.zalocoders.dvtweatherapp.data.models.Weather
import com.zalocoders.dvtweatherapp.data.models.Wind


object SampleResponses {

    val fakeForeCasts = ForeCastResponse(
            lat = -1.3177,
            lon = 36.8441,
    ...
    val fakeWeatherResponse = CurrentLocationWeatherResponse(
            base = "stations",
